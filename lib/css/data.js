...
const SUPPORT_PROFILES = new Float64Array([
	...
	7700000, 10100000, 1500000, 2300000, 11100000, 11300000, 11100000, 11100000,
...
const SELECTOR_SUPPORTED_FROM = new Map([
	...
	["::target-text", 29],
	["::view-transition", 30],
	["::view-transition-group", 30],
	["::view-transition-image-pair", 30],
	["::view-transition-new", 30],
	["::view-transition-old", 30],
	[":active", 31],
	[":active-view-transition", 32],
	[":active-view-transition-type", 33],
	[":any-link", 34],
	[":autofill", 35],
	[":buffering", 36],
	[":checked", 37],
