 ...
 * has to enumerate it.
 * @typedef {Pick<CssProcessOptions, "environment" | "convertLengthUnits" | "rewriteCustomProperties" | "renderEmbeddedSource" | "deferEmbeddedSource" | "transforms" | "unusedSymbols">} CssPrintOptions
 */
...
const _colorFallbackDeclaration = (text, colon) => {
	...
	return text.slice(0, colon + 1) + written;
};
