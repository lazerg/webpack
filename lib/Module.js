...
/** @import { OptimizationBailouts } from "./ModuleGraph" */
 ...
 * @property {Map<string, string>=} exportsBindingSourceByRuntime export definitions `ModuleLibraryPlugin` took over, re-emitted only where the module is wrapped
 */
